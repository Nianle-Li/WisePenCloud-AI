from chat.application.tools.core.definition import ToolParametersSchema


from typing import Any

from chat.application.tools.core.definition import ToolPolicy
        ...
        for key, value in arguments.items():
            ...
            if expected_type and not self._matches_type(value, expected_type):
                return ToolPreflightResult(
                    ok=False,
                    message=("Invalid type for argument '{key}'. Expected {expected_type}, got {type(value).__name__}."),
                )
